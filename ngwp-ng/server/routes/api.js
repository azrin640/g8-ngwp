...
const hwpUserController = require('../controllers/hwpUserController');
const hwpProductsController = require('../controllers/hwpProductsController');
...
router.post('/hwp/user/login', 
    catchErrors(hwpUserController.getLogin)
);

router.post('/hwp/user/register', 
    catchErrors(hwpUserController.registerUser)
);

router.get('/products',
    hwpProductsController.getProducts
);

router.get('/products/categories',
    hwpProductsController.getCategories
);
